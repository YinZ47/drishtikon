/*
  Bio-tuned Eye Controller (ESP32 / AVR)  -- REF
  Protocol unchanged. Added harmless HRMODE reply for broadcast convenience.
*/
...
void printHelp(){
  ...
  Serial.println(F("  MODE HOST | MODE AUTO"));
  Serial.println(F("  G x y         (normalized [-1..1])"));
  Serial.println(F("  CENTER | BLINK | OPEN o | RAW mf mb"));
  Serial.println(F("  STATUS | PING | HELP | SCAR ON|OFF | HRMODE name"));
}
